...
export default function BedtimeStoriesScreen() {
    ...
    <ScrollView style={L.screen} contentContainerStyle={[L.content, { paddingTop: 50 }]} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        ...
        <View style={{ flex: 1, marginLeft: 12 }}>
          <Text style={styles.overline}>GÓC CHUYỆN KỂ CỦA BÉ</Text>
      ...
      <View style={styles.searchBox}>
        ...
        <TextInput
          ...
          placeholder="Tìm truyện theo tên, bài học..."
      ...
      {/* Story List */}
      <Text style={L.sectionTitle}>Thư viện truyện cổ tích ({filteredStories.length})</Text>
