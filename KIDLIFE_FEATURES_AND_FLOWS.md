...
2. [Toàn Bộ Tính Năng & Luồng Người Dùng Phía Phụ Huynh (Parent Web App)](#-2-toàn-bộ-tính-năng--luồng-người-dùng-phía-phụ-huynh-parent-web-app)
...
3. [Toàn Bộ Tính Năng & Luồng Người Dùng Phía Các Bé (Child Web App)](#-3-toàn-bộ-tính-năng--luồng-người-dùng-phía-các-bé-child-web-app)
...
**KidLife** là một hệ sinh thái nền tảng web app giáo dục hành vi kỹ thuật số dành cho gia đình. Ứng dụng giúp cha mẹ đồng hành cùng con trẻ trong việc xây dựng nếp sống tự lập, rèn luyện kỹ năng sống, quản lý tài chính sớm và gắn kết tình cảm gia đình thông qua phương pháp **Gamification (Game hóa việc nhà)** và **AI trợ lý giáo dục**.
...
## 👨‍👩‍👧‍👦 2. TOÀN BỘ TÍNH NĂNG & LUỒNG NGƯỜI DÙNG PHÍA PHỤ HUYNH (PARENT WEB APP)
...
## 🧒 3. TOÀN BỘ TÍNH NĂNG & LUỒNG NGƯỜI DÙNG PHÍA CÁC BÉ (CHILD WEB APP)
...
- **Luồng người dùng (User Flow):**
  1. Bé mở web app ở chế độ Trẻ em → Mascot Hamster vui vẻ cất lời chào: *"Chào Minh Anh! Cùng làm nhiệm vụ kiếm sao nhé!"*.
...
`web/src/shared/constants/kidlifeMockData.ts`
