...
router.post('/', requireAuth, requireRole(['PARENT']), ChildController.createChild);
...
router.put('/:id', requireAuth, requireRole(['PARENT']), validateObjectId('id'), ChildController.updateChild);
