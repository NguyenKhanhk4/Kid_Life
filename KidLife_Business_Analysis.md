...
**KidLife** là một nền tảng công nghệ giáo dục (EdTech) tiên phong ứng dụng Trí tuệ nhân tạo (AI Video Generation) dành cho gia đình, hỗ trợ **phụ huynh đồng hành cùng con trong độ tuổi 4–10** để xây dựng thói quen tốt và phát triển kỹ năng sống.

Thay vì để trẻ tiếp xúc thụ động với nội dung số hoặc làm các bài trắc nghiệm khô khan, KidLife biến quá trình rèn luyện thành một trải nghiệm sống động:
1. Phụ huynh giao **nhiệm vụ hằng ngày** (đánh răng, dọn đồ chơi, chào hỏi lễ phép…) bằng cách nhập mô tả.
2. Hệ thống sử dụng **AI Gen Video** để ngay lập tức tạo ra một đoạn video hoạt hình ngắn mô phỏng nhiệm vụ đó một cách sinh động, hấp dẫn.
3. Trẻ em mở app, xem đoạn Video AI này và **bắt chước làm theo**.
4. Trẻ tự quay lại cảnh mình làm nhiệm vụ (nộp Evidence), hệ thống dùng **Vision AI** chấm điểm tự động và gửi cho phụ huynh phê duyệt cuối cùng.
5. Bé nhận **phần thưởng ảo** (điểm, huy hiệu, chăm sóc thú cưng ảo).

KidLife định vị là "người bạn đồng hành AI" — kết hợp **công nghệ GenAI**, **cơ chế tạo động lực bằng game**, và **sự giám sát an toàn của phụ huynh**.
...
| 3 | Việc dạy kỹ năng sống thường khô khan, trẻ khó hình dung cách làm thực tế | Ứng dụng **AI Video Generation** tự động tạo ra video hoạt hình trực quan sinh động theo đúng yêu cầu nhiệm vụ của phụ huynh để trẻ bắt chước làm theo. Chuyên gia (Expert) chỉ đóng vai trò duyệt các "Prompt chuẩn" để AI tạo video an toàn. |
| 4 | Khó xác minh trẻ có thực sự hoàn thành nhiệm vụ ngoài đời hay không | Ứng dụng **Vision AI** để quét video bé nộp xem bé có thực sự làm nhiệm vụ không + phụ huynh phê duyệt (Parent Override) |
...
| **Đối tác nội dung (Expert)** | Chuyên gia giáo dục, tâm lý, kỹ năng sống | Không cần tự quay video. Họ cung cấp, tinh chỉnh và kiểm duyệt các **AI Prompt Templates** để đảm bảo video do AI sinh ra luôn an toàn, mang tính giáo dục cao cho trẻ 4-10 tuổi. |
...
- **Sức mạnh AI (AI-Powered):** Tận dụng công nghệ AI Video Generation (Tạo video từ text) để biến mọi mệnh lệnh khô khan của phụ huynh thành một đoạn video giải trí, trực quan, giúp trẻ dễ dàng bắt chước.
- **Nội dung đáng tin cậy (Trusted Prompting):** Video sinh ra bởi AI được kiểm soát chặt chẽ thông qua bộ khung Prompt Templates do các Chuyên gia (Expert) thẩm định.
...
| Phương thức truyền đạt | Bố mẹ giao việc bằng **Video hoạt hình do AI tạo tức thì** (Sinh động, cá nhân hóa) | Bố mẹ giao việc bằng Text hoặc Voice khô khan |
| Vai trò Chuyên gia | Xây dựng bộ khung Prompt AI an toàn, tối ưu cho trẻ | Tự quay/sản xuất video tốn kém thời gian |
| Cơ chế động lực | Thú cưng ảo + ví điểm + huy hiệu gắn với hành vi thực | Điểm số đơn thuần |

> **Tuyên bố khác biệt:** *KidLife là nền tảng duy nhất sử dụng công nghệ AI Video Generation để biến mọi nhiệm vụ hằng ngày của trẻ thành những đoạn video hoạt hình sinh động, thúc đẩy trẻ tự giác làm theo dưới sự giám sát của phụ huynh.*
...
| Nội dung | Số video nhiệm vụ/aiVideo được Expert đóng góp và duyệt | Tăng trưởng đều |
...
| Nội dung giáo dục | CMS video nhiệm vụ (TaskVideoTemplate), AIVideo, AIPrompt, phân loại theo Skill và độ tuổi |
...
- Cơ chế AI tự sinh nội dung video nhiệm vụ hoàn chỉnh thay thế Expert.
...
| **Trách nhiệm** | Học bài, làm aiVideo, thực hiện nhiệm vụ, nộp bằng chứng |
...
| Thuộc tính | Nội dung |
|------------|----------|
| **Vai trò** | Người sản xuất nội dung giáo dục (video nhiệm vụ, aiVideo, nhiệm vụ mẫu) |
...
| Thuộc tính | Nội dung |
|------------|----------|
| **Vai trò** | Lưu trữ tệp media (ảnh/video bằng chứng, hình video nhiệm vụ, avatar) |
...
| **Chức năng KHÔNG được phép** | Tạo/duyệt video nhiệm vụ của người khác, quản lý người dùng hệ thống, cấu hình hệ thống, truy cập dữ liệu gia đình khác |
...
| **Quyền hạn** | Xem/học bài được giao, làm aiVideo, xem nhiệm vụ, nộp bằng chứng, xem ví điểm, chăm sóc Pet, đổi thưởng trong giới hạn phụ huynh cho phép |
...
| **Chức năng được phép** | Học bài, làm aiVideo, thực hiện & nộp nhiệm vụ, xem điểm/huy hiệu, chăm sóc Pet, đổi thưởng (có kiểm soát) |
...
| **Mục tiêu** | Đóng góp video nhiệm vụ/aiVideo/nhiệm vụ chất lượng, xây dựng uy tín |
| **Quyền hạn** | Tạo/sửa/xóa nội dung của chính mình (TaskVideoTemplate, AIVideo, AIPrompt, Mission mẫu); gửi nội dung để duyệt; xem thống kê nội dung của mình |
...
| **Chức năng** | Tạo/sửa/xóa TaskVideoTemplate, Skill; gửi duyệt; Admin duyệt/từ chối/publish; phân loại theo độ tuổi |
| **Input** | Nội dung video nhiệm vụ, media, phân loại kỹ năng/độ tuổi |
| **Output** | Video Nhiệm vụ đã publish, thư viện nội dung |
| **Entity liên quan** | TaskVideoTemplate, Skill |
...
| **Input** | Sự kiện hoàn thành (nhiệm vụ, aiVideo, video nhiệm vụ) |
...
| **Entity liên quan** | ChildProfile, Mission, Submission, Transaction, TaskVideoTemplate |
...
#### Education CMS
Expert soạn TaskVideoTemplate (nội dung, media, độ tuổi, kỹ năng); tạo/quản lý Skill; gửi duyệt; Admin duyệt/từ chối/publish/gỡ; Parent/Child duyệt xem thư viện theo độ tuổi.
...
#### AIVideo
Expert tạo AIVideo gắn với TaskVideoTemplate; ngân hàng AIPrompt; Child làm aiVideo; chấm điểm tự động; lưu và hiển thị kết quả; cộng điểm thưởng.
...
#### Child
Đăng nhập giao diện thân thiện; học bài & làm aiVideo; xem & thực hiện nhiệm vụ; chụp/quay và nộp bằng chứng; xem điểm, huy hiệu, cấp độ; chăm sóc Pet; đổi thưởng trong giới hạn.

#### Expert
Soạn TaskVideoTemplate/AIVideo/AIPrompt/nhiệm vụ mẫu; gửi duyệt; chỉnh sửa nội dung của mình; xem thống kê hiệu quả nội dung; nhận thông báo kết quả duyệt.
...
| Mã | Yêu cầu chức năng | Vai trò | Ưu tiên |
|----|--------------------|---------|---------|
| FR-022 | Expert có thể tạo video nhiệm vụ (TaskVideoTemplate) với nội dung, media, phân loại độ tuổi và kỹ năng | Expert | Cao |
| FR-023 | Expert có thể cập nhật video nhiệm vụ do mình tạo | Expert | Cao |
| FR-024 | Expert có thể xóa video nhiệm vụ do mình tạo (khi chưa publish) | Expert | Trung bình |
| FR-025 | Expert có thể gửi video nhiệm vụ để Admin kiểm duyệt | Expert | Cao |
| FR-026 | Admin có thể xem danh sách nội dung chờ duyệt | Admin | Cao |
| FR-027 | Admin có thể phê duyệt và publish video nhiệm vụ | Admin | Cao |
| FR-028 | Admin có thể từ chối video nhiệm vụ kèm lý do | Admin | Cao |
| FR-029 | Admin có thể gỡ (unpublish) video nhiệm vụ đã publish | Admin | Trung bình |
| FR-030 | Hệ thống quản lý danh mục Skill (kỹ năng) | Expert, Admin | Trung bình |
| FR-031 | Parent/Child có thể duyệt xem thư viện video nhiệm vụ đã publish theo độ tuổi | Parent, Child | Cao |
| FR-032 | Hệ thống lọc nội dung theo độ tuổi phù hợp với hồ sơ trẻ | Hệ thống | Cao |
| FR-033 | Child có thể xem chi tiết và học một video nhiệm vụ được giao | Child | Cao |
| FR-034 | Hệ thống ghi nhận trạng thái hoàn thành video nhiệm vụ của trẻ | Hệ thống | Cao |
...
### 8.5. AIVideo (FR-047 → FR-055)

| Mã | Yêu cầu chức năng | Vai trò | Ưu tiên |
|----|--------------------|---------|---------|
| FR-047 | Expert có thể tạo aiVideo gắn với một video nhiệm vụ | Expert | Cao |
| FR-048 | Expert có thể thêm câu hỏi (AIPrompt) và đáp án vào aiVideo | Expert | Cao |
| FR-049 | Expert có thể cập nhật/xóa câu hỏi của aiVideo | Expert | Trung bình |
| FR-050 | Child có thể làm aiVideo được giao | Child | Cao |
| FR-051 | Hệ thống chấm điểm aiVideo tự động | Hệ thống | Cao |
| FR-052 | Hệ thống hiển thị kết quả và đáp án đúng sau khi nộp | Child | Trung bình |
| FR-053 | Hệ thống cộng điểm thưởng vào ví khi trẻ đạt ngưỡng aiVideo | Hệ thống | Cao |
| FR-054 | Hệ thống lưu lịch sử làm aiVideo của trẻ | Hệ thống | Trung bình |
| FR-055 | Parent có thể xem kết quả aiVideo của con | Parent | Trung bình |
...
| Mã | Yêu cầu chức năng | Vai trò | Ưu tiên |
|----|--------------------|---------|---------|
| FR-067 | Hệ thống cộng điểm cho trẻ khi hoàn thành nhiệm vụ/aiVideo/video nhiệm vụ | Hệ thống | Cao |
...
| BR-008 | Điểm thưởng chỉ được cộng vào ví khi nhiệm vụ/aiVideo/video nhiệm vụ được ghi nhận hoàn thành hợp lệ |
...
```
Expert soạn nội dung (TaskVideoTemplate/AIVideo)
   → Expert gửi duyệt
...
```
Child đăng nhập
   → Xem video nhiệm vụ được giao / thư viện theo độ tuổi
   → Học bài → Làm aiVideo gắn với bài
...
| Học & chơi | Học bài, làm aiVideo vui | Vui, muốn khám phá |
...
| Soạn nội dung | Tạo video nhiệm vụ/aiVideo | Muốn công cụ dễ dùng |
...
### 13.3. TaskVideoTemplate (Học bài)

1. Child chọn video nhiệm vụ được giao hoặc trong thư viện theo độ tuổi.
2. Hệ thống hiển thị nội dung video nhiệm vụ (văn bản, media).
3. Child hoàn thành video nhiệm vụ.
4. Hệ thống ghi nhận trạng thái hoàn thành và có thể gợi ý aiVideo liên quan.
5. Ngoại lệ: video nhiệm vụ bị gỡ → ẩn khỏi danh sách.

### 13.4. AIVideo

1. Child bắt đầu aiVideo gắn với video nhiệm vụ.
...
> Các Use Case còn lại (đăng ký, học bài, làm aiVideo, quản lý người dùng, xem báo cáo, cấu hình hệ thống, quản lý phần thưởng, thông báo…) được mô tả theo cùng cấu trúc 10 thành phần trên.
...
| TaskVideoTemplate | R | R | C, R, U, D (của mình) | R, U, D (duyệt/gỡ) |
| AIVideo | R | R | C, R, U, D (của mình) | R, D |
| AIPrompt | R | R | C, R, U, D (của mình) | R, D |
...
**Quan hệ:** 1 User (Parent) — N ChildProfile; 1 User (Expert) — N TaskVideoTemplate; 1 User — N Notification; 1 User — 1 Subscription.
...
**Quan hệ:** 1 Skill — N TaskVideoTemplate; 1 Skill — N Mission (Many-to-Many qua tham chiếu).

### 17.4. TaskVideoTemplate

**Ý nghĩa:** Video Nhiệm vụ giáo dục do Expert biên soạn.
...
**Quan hệ:** N TaskVideoTemplate — 1 Expert; 1 TaskVideoTemplate — N AIVideo; N TaskVideoTemplate — 1 Skill.

### 17.5. AIVideo

**Ý nghĩa:** Bộ câu hỏi xem video làm theo gắn với video nhiệm vụ.

| Thuộc tính | Kiểu dữ liệu | PK | FK | Mô tả |
|------------|--------------|:--:|:--:|-------|
| _id | ObjectId | ✅ | | Khóa chính |
| taskVideoTemplateId | ObjectId | | ✅ (TaskVideoTemplate) | Video Nhiệm vụ liên quan |
| title | String | | | Tiêu đề aiVideo |
| passScore | Number | | | Điểm đạt tối thiểu |
| rewardPoints | Number | | | Điểm thưởng khi đạt |
| authorId | ObjectId | | ✅ (User) | Expert tạo |
| createdAt | DateTime | | | Ngày tạo |

**Quan hệ:** N AIVideo — 1 TaskVideoTemplate; 1 AIVideo — N AIPrompt.

### 17.6. AIPrompt

**Ý nghĩa:** Câu hỏi thuộc một aiVideo.

| Thuộc tính | Kiểu dữ liệu | PK | FK | Mô tả |
|------------|--------------|:--:|:--:|-------|
| _id | ObjectId | ✅ | | Khóa chính |
| aiVideoId | ObjectId | | ✅ (AIVideo) | AIVideo chứa câu hỏi |
| content | String | | | Nội dung câu hỏi |
| options | Array(String) | | | Các lựa chọn |
| correctIndex | Number | | | Chỉ số đáp án đúng |
| mediaUrl | String | | | Hình minh họa (nếu có) |

**Quan hệ:** N AIPrompt — 1 AIVideo.
...
| User (Expert) — TaskVideoTemplate | Một chuyên gia tạo nhiều video nhiệm vụ |
| TaskVideoTemplate — AIVideo | Một video nhiệm vụ có thể có nhiều aiVideo |
| AIVideo — AIPrompt | Một aiVideo gồm nhiều câu hỏi |
...
| VR-06 | TaskVideoTemplate.title | Bắt buộc, 3–150 ký tự |
| VR-07 | TaskVideoTemplate.ageRange | min ≤ max, nằm trong 4–10 |
| VR-08 | AIVideo.passScore | Số ≥ 0 và ≤ tổng điểm aiVideo |
| VR-09 | AIPrompt.correctIndex | Chỉ số hợp lệ trong mảng options |
| VR-10 | AIPrompt.options | Tối thiểu 2 lựa chọn |
...
| TaskVideoTemplate | POST /taskVideoTemplates | Tạo video nhiệm vụ | ✅ | Expert |
| TaskVideoTemplate | GET /taskVideoTemplates | Danh sách/tìm video nhiệm vụ | ✅ | Tất cả |
| TaskVideoTemplate | GET /taskVideoTemplates/{id} | Chi tiết video nhiệm vụ | ✅ | Tất cả |
| TaskVideoTemplate | PUT /taskVideoTemplates/{id} | Cập nhật video nhiệm vụ | ✅ | Expert |
| TaskVideoTemplate | POST /taskVideoTemplates/{id}/submit | Gửi duyệt | ✅ | Expert |
| TaskVideoTemplate | PATCH /taskVideoTemplates/{id}/moderate | Duyệt/từ chối/publish | ✅ | Admin |
| AIVideo | POST /aiVideozes | Tạo aiVideo | ✅ | Expert |
| AIVideo | GET /aiVideozes/{id} | Lấy aiVideo | ✅ | Child, Parent |
| AIVideo | POST /aiVideozes/{id}/submit | Nộp bài aiVideo | ✅ | Child |
...
| S-09 | Trang chủ Trẻ em | Child | Nhiệm vụ, video nhiệm vụ, Pet |
| S-10 | Học bài | Child | Xem nội dung video nhiệm vụ |
| S-11 | Làm AIVideo | Child | Trả lời câu hỏi |
...
| S-15 | Trang Expert – Soạn nội dung | Expert | Tạo TaskVideoTemplate/AIVideo |
...
| Thành phần | Nội dung |
|------------|----------|
| **Purpose** | Điểm khởi đầu vui nhộn, dẫn trẻ tới nhiệm vụ/video nhiệm vụ/Pet |
| **Actor** | Child |
...
| **API sử dụng** | GET /taskVideoTemplates?status=pending; PATCH /taskVideoTemplates/{id}/moderate |
...
Đăng nhập → Trang chủ Trẻ (Pet + điểm)
   ...
   ├─ Học bài → Video Nhiệm vụ → AIVideo → Kết quả
   ├─ Ví điểm → Đổi thưởng
...
Đăng nhập → Trang Expert
   ├─ Soạn nội dung → Tạo TaskVideoTemplate/AIVideo → Gửi duyệt
...
### 24.3. TaskVideoTemplate (Video Nhiệm vụ)
...
### 24.4. AIVideo (Lượt làm aiVideo của trẻ)
...
- **(Mở rộng) Gợi ý nội dung/nhiệm vụ:** đề xuất video nhiệm vụ/nhiệm vụ phù hợp độ tuổi và kỹ năng.
...
| Thuộc tính | Nội dung |
|------------|----------|
| **Mục đích** | Lưu trữ media (bằng chứng, ảnh video nhiệm vụ, avatar) |
...
# PHỤ LỤC: ĐẶC TẢ NGHIỆP VỤ AI VIDEO GENERATION (CỐT LÕI SẢN PHẨM)

Sản phẩm KidLife có điểm nhấn khác biệt (Unique Selling Point) so với các ứng dụng học tập truyền thống là **không sử dụng hệ thống Quiz/Bài giảng khô khan**, mà ứng dụng **AI Video Generation** để biến mọi nhiệm vụ thành một đoạn video giải trí thu hút trẻ em.

## 1. Hành trình người dùng (User Journey) của tính năng cốt lõi

- **Touchpoint 1 (Phụ huynh tạo nhiệm vụ):** Phụ huynh mở app, nhập mô tả công việc (VD: "Mẹ muốn con dọn đồ chơi lúc 8h tối, chủ đề siêu nhân"). Thay vì trẻ chỉ nhận được 1 dòng text khô khan, phụ huynh bấm nút "AI Magic".
- **Touchpoint 2 (AI sinh Video):** Hệ thống kết hợp yêu cầu của phụ huynh với "Prompt chuẩn" do Chuyên gia giáo dục cung cấp (để đảm bảo tính an toàn, ngôn từ phù hợp trẻ em). AI (Runway/Sora) sẽ ngay lập tức sinh ra một đoạn video hoạt hình 15 giây mô tả cảnh siêu nhân đang dọn đồ chơi.
- **Touchpoint 3 (Trẻ tiếp nhận):** Trẻ mở app, giao diện hiển thị video dưới dạng vuốt dọc (giống Tiktok/Shorts). Video sinh động kích thích sự tò mò và hứng thú của trẻ, giúp trẻ hiểu ngay nhiệm vụ cần làm là gì.
- **Touchpoint 4 (Trẻ thực hiện & Nộp bằng chứng):** Trẻ bấm nút "Quay video" ngay trên màn hình để quay cảnh mình đang dọn đồ chơi bắt chước theo siêu nhân.
- **Touchpoint 5 (AI Vision chấm điểm):** Hệ thống Vision AI quét video bé vừa nộp, phân tích hành vi và gửi thông báo xác nhận: "Bé đã dọn đồ chơi thành công 90%" cho phụ huynh phê duyệt cuối cùng.

## 2. Vai trò thực sự của Chuyên gia (Expert)

Thay vì "Soạn bài giảng" hay "Tạo câu hỏi trắc nghiệm" tốn kém thời gian quay dựng, Chuyên gia trên KidLife đóng vai trò là những **AI Prompt Engineers chuyên ngành giáo dục mầm non**:
- Họ nghiên cứu và viết ra các cấu trúc lệnh (Prompt Templates) tối ưu để ép AI phải sinh ra các video có tính giáo dục cao, không bạo lực, màu sắc thân thiện với trẻ em.
- Họ kiểm duyệt kết quả sinh video mẫu để đảm bảo hệ thống tự động chạy ổn định.

Với luồng nghiệp vụ này, KidLife vừa tự động hóa hoàn toàn việc sản xuất nội dung, vừa đảm bảo tính cá nhân hóa 100% cho từng nhiệm vụ của từng gia đình, tạo ra sức hút khổng lồ đối với trẻ nhỏ.
